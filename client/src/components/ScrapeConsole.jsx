...
function ScrapeConsole({ savedProducts, onSaveProducts, addToast }) {
  ...
  const simulateScrapeLogs = async () => {
    ...
    addLog(`CONFIG: Query="${query}" | Source=${source.toUpperCase()} | Pages=${pages}`, 'accent');
    await new Promise(r => setTimeout(r, 200));
    ...
    try {
      const response = await fetch('/api/scrape', {
        ...
        body: JSON.stringify({ query: query.trim(), source, pages })
      });
    ...
    <div style={{ animation: 'fadeIn 0.3s ease-out' }}>
      ...
      <div className="view-header">
        <div className="view-title">
          ...
          <p>Scrape individual or combined catalog sets from Flipkart and Snapdeal</p>
        </div>
      </div>
        ...
        <div className="scraper-input-panel">
          <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div className="input-box-wrapper">
              ...
              <input 
                type="text" 
                placeholder="e.g. laptop, headphones, sneakers..." 
            ...
            <div className="input-box-wrapper">
              ...
              >
                ...
                <option value="all">All Stores (Flipkart & Snapdeal)</option>
              </select>
            </div>
